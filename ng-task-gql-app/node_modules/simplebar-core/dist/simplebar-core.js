(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('lodash'), require('can-use-dom')) :
  typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', 'lodash', 'can-use-dom'], factory) :
  (global = global || self, global.SimpleBar = factory(global._defineProperty, global._classCallCheck, global._createClass, global._, global.canUseDOM));
}(this, (function (_defineProperty, _classCallCheck, _createClass, lodashEs, canUseDOM) { 'use strict';
  ...
  var SimpleBar = /*#__PURE__*/function () {
    function SimpleBar(element) {
      ...
      this.onMouseMove = lodashEs.throttle(this.onMouseMove, 64);
      this.onWindowResize = lodashEs.debounce(this.onWindowResize, 64, {
        leading: true
      });
      this.onStopScrolling = lodashEs.debounce(this.onStopScrolling, this.stopScrollDelay);
      this.onMouseEntered = lodashEs.debounce(this.onMouseEntered, this.stopScrollDelay);
      this.init();
    }
    /**
     * Static properties
...
//# sourceMappingURL=simplebar-core.js.map

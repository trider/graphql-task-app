...
declare type Execution = typeof execute;
declare type Subscription = typeof subscribe;
export declare type ApolloExecutor = (requestContext: ApolloRequestContext) => ValueOrPromise<ExecutionResult>;
